      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="p-4 flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">ID: DEMO123456</div>
          </div>
        </div>

        {/* 资产概览 */}
        <div className="m-4 bg-gradient-to-r from-blue-900/50 to-purple-900/50 rounded-xl p-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <div className="text-gray-400">累计盈亏</div>
          ...
          <div className="bg-gray-800/50 rounded-xl divide-y divide-gray-700/50">
            {[
              ...
              <Link
                key={item.label}
                href={item.href}
                className="flex items-center justify-between px-4 py-4 hover:bg-gray-700/50 transition"
              >
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800">
        <div className="max-w-lg mx-auto flex">
          {[
            ...
            { icon: '👤', label: '我的', href: '/account', active: true },
          ].map(item => (
            <Link
              key={item.label}
              href={item.href}
